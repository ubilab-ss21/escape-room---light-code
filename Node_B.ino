...
WiFiClient node1_saba;
PubSubClient client(node1_saba);
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    if ( buttonState == HIGH){
      client.publish("ubilab/colorcode/BUTTON_1_ID","a",false);
    }
    client.subscribe("ubilab/colorcode/LIGHT_01_ID");
  }
}
